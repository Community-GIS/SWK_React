...
export const FetchGeom = () =>{
    ...
    useEffect(()=>{
        ...
        const urlSpots = "https://communitygis.net/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Aspots_3december&outputFormat=json&srs=EPSG%3A4326&srsName=EPSG%3A4326";
        json(urlZones,zones=>{
            json(urlSpots,spots =>{
                setGeom(zones,spots);
            })
